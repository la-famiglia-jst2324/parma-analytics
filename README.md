...
erDiagram
    ...
    BUCKET ||--o{ BUCKET_ACCESS : "N"

    COMPANY ||--o{ COMPANY_BUCKET_MEMBERSHIP : "N"
    COMPANY ||--o{ NOTIFICATION_SUBSCRIPTION : "has subscribers"
    ...
    NOTIFICATION_SUBSCRIPTION ||--o{ NOTIFICATION_CHANNEL : "N"

    REPORT ||--o{ COMPANY : "contains"
    REPORT_SUBSCRIPTION ||--o{ NOTIFICATION_CHANNEL : "N"
    ...
    USER ||--o{ BUCKET_ACCESS : "create, add company"
