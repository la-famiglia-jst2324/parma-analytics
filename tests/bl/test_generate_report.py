...
def test_generate_report_successful():
    ...
    with patch(
        ...
        mock_get_source_measurement_query.return_value = mock_source_measurement_query
        ...
        mock_get_company_name.assert_called_once_with(mock_engine_instance, company_id)
